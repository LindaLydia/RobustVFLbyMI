...
def main():
    ...
    if args.dataset == 'mnist':
        ...
        train_dataset = NUSWIDEDatasetVFL(DATA_DIR, 'train', 10, target_label, args.backdoor_scale)
        valid_dataset = NUSWIDEDatasetVFL(DATA_DIR, 'test', 10, target_label, args.backdoor_scale)
