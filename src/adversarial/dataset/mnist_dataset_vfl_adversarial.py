...
def data_poison(images, poison_number, noise_scale=0.0, backdoor_scale=1.0):
    ...
    # # images[poison_list, 27, 27] = backdoor_scale
    # # images[poison_list, 26, 26] = backdoor_scale
    # # images[poison_list, 25, 27] = backdoor_scale
    # # images[poison_list, 27, 25] = backdoor_scale
    for idx in poison_list:
        images[idx,:,:] += np.random.normal(loc=0.0, scale=noise_scale, size=(14,28,1))
