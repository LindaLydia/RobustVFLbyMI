...
#     python main_missing.py --name defense --dataset cifar100 --model resnet18 --seed $i --epoch 100 --backdoor 1 --dp_type laplace --dp_strength 0.1 --gpu 0
#     python main_missing.py --name defense --dataset cifar100 --model resnet18 --seed $i --epoch 100 --backdoor 1 --dp_type laplace --dp_strength 0.01 --gpu 0
#     python main_missing.py --name defense --dataset cifar100 --model resnet18 --seed $i --epoch 100 --backdoor 1 --dp_type laplace --dp_strength 0.001 --gpu 0
#     python main_missing.py --name defense --dataset cifar100 --model resnet18 --seed $i --epoch 100 --backdoor 1 --dp_type laplace --dp_strength 0.0001 --gpu 0
#     python main_missing.py --name defense --dataset cifar100 --model resnet18 --seed $i --epoch 100 --backdoor 1 --dp_type gaussian --dp_strength 0.1 --gpu 0
#     python main_missing.py --name defense --dataset cifar100 --model resnet18 --seed $i --epoch 100 --backdoor 1 --dp_type gaussian --dp_strength 0.01 --gpu 0
#     python main_missing.py --name defense --dataset cifar100 --model resnet18 --seed $i --epoch 100 --backdoor 1 --dp_type gaussian --dp_strength 0.001 --gpu 0
#     python main_missing.py --name defense --dataset cifar100 --model resnet18 --seed $i --epoch 100 --backdoor 1 --dp_type gaussian --dp_strength 0.0001 --gpu 0
