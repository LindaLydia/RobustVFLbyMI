...
from dataset.mnist_dataset_vfl_adversarial import MNISTDatasetVFL, need_poison_down_check_mnist_vfl
from dataset.nuswide_dataset_vfl_adversarial import NUSWIDEDatasetVFL, need_poison_down_check_nuswide_vfl

from dataset.cifar10_dataset_vfl_adversarial import Cifar10DatasetVFL, need_poison_down_check_cifar10_vfl
from dataset.cifar100_dataset_vfl_adversarial import Cifar100DatasetVFL, Cifar100DatasetVFL20Classes, \
...
def main():
    ...
    args.name = 'experiment_adversarial_{}/{}-{}-{}-{}-{}-{}-{}-{}-{}-{}-{}-{}-{}-{}-{}-{}-{}-{}-{}-{}-{}-{}-{}-{}-{}-{}'.format(
        args.name, args.epochs, args.dataset, args.model, args.batch_size, args.name,args.backdoor, args.amplify_rate,
        args.amplify_rate_output, args.dp_type, args.dp_strength, args.gradient_sparsification, args.certify, args.sigma, args.autoencoder, args.lba, args.mid, args.mid_lambda, args.apply_distance_correlation, args.distance_correlation_lambda, args.apply_discrete_gradients, args.discrete_gradients_bins, args.seed,
        args.use_project_head, args.random_output, args.learning_rate, time.strftime("%Y%m%d-%H%M%S"))
    utils.create_exp_dir(args.name) # todo: mid, dCor, discrete_gradient
