for i in `seq 1 10`; do 
    ...
    python main.py --name defense --dataset nuswide --model mlp2 --seed $i --epoch 100 --backdoor 1 --lba 1.0 --gpu 0 --apply_discrete_gradients 1 --discrete_gradients_bins 12 --gpu 0
    python main.py --name defense --dataset nuswide --model mlp2 --seed $i --epoch 100 --backdoor 1 --lba 0.5 --gpu 0 --apply_discrete_gradients 1 --discrete_gradients_bins 12 --gpu 0
    python main.py --name defense --dataset nuswide --model mlp2 --seed $i --epoch 100 --backdoor 1 --lba 0.0 --gpu 0 --apply_discrete_gradients 1 --discrete_gradients_bins 12 --gpu 0
    ...
    python main.py --name defense --dataset nuswide --model mlp2 --seed $i --epoch 100 --backdoor 1 --mid 1 --mid_lambda 0.0001 --gpu 0
