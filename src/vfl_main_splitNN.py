...
if __name__ == '__main__':
    ...
    parser.add_argument('--gpu', default=0, type=int, help='cuda id')
    ...
    path = f'./exp_result_splitNN/{args.dataset_name}/'
    ...
    temp_path = path
    path = [temp_path+'main_task_acc.txt', temp_path+'attack_task_acc.txt']
    num_exp = 10
    # num_exp = 1
    ...
    if args.apply_encoder:
        for ae_name in ae_name_list:
            test_acc_list = []
            test_auc_list = []
            norm_scoring_acc_list = []
            cosine_scoring_acc_list = []
            for i in range(num_exp):
                ...
                vfl_defence_image = vfl_splitNN.VFLSplitNN(args)
                test_acc = vfl_defence_image.train()
                test_acc_list.append(test_acc[0])
                test_auc_list.append(test_acc[1])
                norm_scoring_acc_list.append(test_acc[2])
                cosine_scoring_acc_list.append(test_acc[3])
            # append_exp_res(path[0], str(_lambda) + ' ' + str(np.mean(test_acc_list))+ ' ' + str(test_acc_list) + ' ' + str(np.max(test_acc_list)))
            append_exp_res(path[0], str(_lambda) + ' ' + str(np.mean(test_auc_list))+ ' ' + str(test_auc_list) + ' ' + str(np.max(test_auc_list)))
            append_exp_res(path[1], str(_lambda) + ' ' + str(np.mean(cosine_scoring_acc_list))+ ' ' + str(cosine_scoring_acc_list) + ' ' + str(np.max(cosine_scoring_acc_list)))
        ...
        for dp_strength in dp_strength_list:
            ...
            append_exp_res(path[1], str(dp_strength) + ' ' + str(np.mean(cosine_scoring_acc_list))+ ' ' + str(cosine_scoring_acc_list) + ' ' + str(np.max(cosine_scoring_acc_list)))
    elif args.apply_grad_spar:
        ...
        for grad_spars in gradient_sparsification_list:
            ...
            append_exp_res(path[1], str(grad_spars) + ' ' + str(np.mean(cosine_scoring_acc_list))+ ' ' + str(cosine_scoring_acc_list) + ' ' + str(np.max(cosine_scoring_acc_list)))
    elif args.apply_mid:
        ...
        for mid_loss_lambda in mid_lambda_list:
            ...
            for i in range(num_exp):
                ...
                norm_scoring_acc_list.append(test_acc[2])
                cosine_scoring_acc_list.append(test_acc[3])
            # append_exp_res(path, str(mid_loss_lambda) + ' ' + str(np.mean(test_acc_list))+ ' ' + str(test_acc_list) + ' ' + str(np.max(test_acc_list)))
            append_exp_res(path[0], str(mid_loss_lambda) + ' ' + str(np.mean(test_auc_list))+ ' ' + str(test_auc_list) + ' ' + str(np.max(test_auc_list)))
            append_exp_res(path[1], str(mid_loss_lambda) + ' ' + str(np.mean(cosine_scoring_acc_list))+ ' ' + str(cosine_scoring_acc_list) + ' ' + str(np.max(cosine_scoring_acc_list)))
    else:
        test_acc_list = []
        test_auc_list = []
        norm_scoring_acc_list = []
        ...
        if args.apply_mi:
            ...
            append_exp_res(path[1], str(args.mi_loss_lambda) + ' ' + str(np.mean(cosine_scoring_acc_list))+ ' ' + str(cosine_scoring_acc_list) + ' ' + str(np.max(cosine_scoring_acc_list)))
            ...
            append_exp_res(path[1], str(args.distance_correlation_lambda) + ' ' + str(np.mean(cosine_scoring_acc_list))+ ' ' + str(cosine_scoring_acc_list) + ' ' + str(np.max(cosine_scoring_acc_list)))
            ...
            append_exp_res(path[1], str(args.discrete_gradients_bins) + ' ' + str(np.mean(cosine_scoring_acc_list))+ ' ' + str(cosine_scoring_acc_list) + ' ' + str(np.max(cosine_scoring_acc_list)))
        else:
            ...
            append_exp_res(path[1], "bs|num_class|recovery_rate," + str(args.batch_size) + '|' + str(num_classes) + ' ' + str(cosine_scoring_acc_list) + ' ' + str(np.max(cosine_scoring_acc_list)))
