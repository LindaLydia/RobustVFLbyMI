...
# python vfl_dlg_no_defense.py --apply_distance_correlation True --distance_correlation_lambda 1e-3
# python vfl_main_task_no_defense.py --apply_grad_perturb True --epochs 30
# python vfl_dlg_no_defense.py --apply_grad_perturb True
...
# python vfl_main_task_no_defense.py --apply_RRwithPrior True --RRwithPrior_epsilon 2.0 --epochs 30
# python vfl_main_task_no_defense.py --apply_RRwithPrior True --RRwithPrior_epsilon 4.0
# python vfl_main_task_no_defense.py --apply_RRwithPrior True --RRwithPrior_epsilon 5.0
# python vfl_main_task_no_defense.py --apply_RRwithPrior True --RRwithPrior_epsilon 6.0
# python vfl_main_task_no_defense.py --apply_RRwithPrior True --RRwithPrior_epsilon 7.0
# python vfl_main_task_no_defense.py --apply_RRwithPrior True --RRwithPrior_epsilon 10.0
python vfl_dlg_no_defense.py --apply_RRwithPrior True --RRwithPrior_epsilon 2.0
python vfl_dlg_no_defense.py --apply_RRwithPrior True --RRwithPrior_epsilon 4.0
python vfl_dlg_no_defense.py --apply_RRwithPrior True --RRwithPrior_epsilon 5.0
python vfl_dlg_no_defense.py --apply_RRwithPrior True --RRwithPrior_epsilon 6.0
python vfl_dlg_no_defense.py --apply_RRwithPrior True --RRwithPrior_epsilon 7.0
python vfl_dlg_no_defense.py --apply_RRwithPrior True --RRwithPrior_epsilon 10.0
