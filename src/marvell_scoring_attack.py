            ...
            for num_classes in self.num_class_list:
                ...
                for i_run in range(1, self.num_exp + 1):
                    ...
                    norm_leak_auc = update_all_norm_leak_auc(
                        ...
                        y=tf_gt_label)
                    cosine_leak_auc = update_all_cosine_leak_auc(
                ...
                if self.apply_laplace or self.apply_gaussian:
                    exp_result = str(self.dp_strength) + ' ' + str(np.mean(norm_leak_auc_history)) + ' ' + str(norm_leak_auc_history) + ' ' + str(np.max(norm_leak_auc_history))
                    exp_result1 = str(self.dp_strength) + ' ' + str(np.mean(cosine_leak_auc_history)) + ' ' + str(cosine_leak_auc_history) + ' ' + str(np.max(cosine_leak_auc_history))
                elif self.apply_grad_spar:
                    exp_result = str(self.grad_spars) + ' ' + str(np.mean(norm_leak_auc_history)) + ' ' + str(norm_leak_auc_history) + ' ' + str(np.max(norm_leak_auc_history))
                    exp_result1 = str(self.grad_spars) + ' ' + str(np.mean(cosine_leak_auc_history)) + ' ' + str(cosine_leak_auc_history) + ' ' + str(np.max(cosine_leak_auc_history))
                ...
                # elif self.apply_ppdl:
                #     exp_result = str(self.ppdl_theta_u) + ' ' + str(np.mean(norm_leak_auc_history)) + ' ' + str(norm_leak_auc_history) + ' ' + str(np.max(norm_leak_auc_history))
                #     exp_result1 = str(self.ppdl_theta_u) + ' ' + str(np.mean(cosine_leak_auc_history)) + ' ' + str(cosine_leak_auc_history) + ' ' + str(np.max(cosine_leak_auc_history))
                # elif self.apply_gc:
                #     exp_result = str(self.gc_preserved_percent) + ' ' + str(np.mean(norm_leak_auc_history)) + ' ' + str(norm_leak_auc_history) + ' ' + str(np.max(norm_leak_auc_history))
                #     exp_result1 = str(self.gc_preserved_percent) + ' ' + str(np.mean(cosine_leak_auc_history)) + ' ' + str(cosine_leak_auc_history) + ' ' + str(np.max(cosine_leak_auc_history))
                # elif self.apply_lap_noise:
                ...
                #     exp_result1 = str(self.noise_scale) + ' ' + str(np.mean(cosine_leak_auc_history)) + ' ' + str(cosine_leak_auc_history) + ' ' + str(np.max(cosine_leak_auc_history))
                    ...
                    exp_result = f"bs|num_class|recovery_rate,%d|%d| %lf %s %lf" % (batch_size, num_classes, np.mean(norm_leak_auc_history), str(norm_leak_auc_history), np.max(norm_leak_auc_history))
                    exp_result1 = f"bs|num_class|recovery_rate,%d|%d| %lf %s %lf" % (batch_size, num_classes, np.mean(cosine_leak_auc_history), str(cosine_leak_auc_history), np.max(cosine_leak_auc_history))
